      ...
      <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 flex justify-center">
          <div className="w-full max-w-md rounded-3xl bg-slate-950/20 backdrop-blur-xl border border-white/10 shadow-2xl shadow-purple-900/40 px-8 py-10">
            ...
            <div className="mt-6 rounded-2xl bg-slate-900/80 border border-slate-700/70 px-4 py-3 text-xs text-slate-300">
              Your grantor profile helps us tailor the validation workflow for
              your scholarship program. You can update these details later from
              your dashboard.
            </div>
          </div>
        </div>
